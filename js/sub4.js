...
function openResult() {
    ...
    const isPerfume = score % 2 === 0;
    resultImage.src = isPerfume ? '../images/sub4/test_result_perfume.jpg' : '../images/sub4/test_result_sea.jpg';
    resultTitle.textContent = isPerfume ? '오늘의 향은 SEA BREEZE' : '오늘의 바다는 SUNSET TIDE';
    resultText.innerHTML = isPerfume
        ? '맑은 바람처럼 가볍게 흐르는 마음이에요.<br>지금의 감정을 향으로 천천히 간직해보세요.'
        : '잔잔한 노을처럼 따뜻한 여운이 머무는 마음이에요.<br>오늘의 감정을 서두르지 말고 바라봐 주세요.';
